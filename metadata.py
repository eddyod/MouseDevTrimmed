...
print('Setting environment for eodonnell compute node')
HOST_ID = 'workstation'
ROOT_DIR = os.path.join(os.getcwd(), 'demo_data')

ON_AWS = False
S3_DATA_BUCKET = 'mousebrainatlas-data'
S3_RAWDATA_BUCKET = 'mousebrainatlas-rawdata'
S3_DATA_DIR = 'CSHL_data_processed'
REPO_DIR = '/home/eodonnell/git/MouseBrainAtlas_dev/src'
...
BRAINS_INFO_DIR = os.path.join(ROOT_DIR, 'brains_info')
