...
from metadata import KDU_EXPAND_BIN
from data_manager import DataManager
from distributed_utilities import run_distributed
...
for vr, data_dir in data_dirs.items():
...
for vr, img_names in image_names_all_data_dirs.items():
    print(vr, 'missing:')
